...
const onSubmitHandler = async (event) => {
  ...
  try {
    ...
    if (!token) {
      toast.error("You must be logged in to register a hotel.");
      return;
    }
          console.log("Submitting hotel registration with:", { name, phone, address, city });
  ...
  return (
    ...
    >
      <form
        ...
        className="flex bg-white rounded-xl max-w-4xl max-md:2"
      >
        <img
          src={assets.regImage}
          alt="regImage"
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10 ">
          ...
          <div className="w-full mt-4 max-w-60 mr-auto ">
            ...
            <select
              ...
              required
            >
              <option value="">Select City</option>q
              {cities.map((city) => (
